...
def console_lines(result: Result) -> list[str]:
    """Human report grouped by model, then a summary. Advisory wording."""
    lines: list[str] = []
    ...
    lines.append("")
    lines.append(f"Checked {result.models_checked} model(s): {head}.")
